<?php
    ...
    echo "<tr><td>". $_SESSION['idPedido']."</td><td>$i</td> 
    <td> ".lista($base->link, 'http://localhost/DWES-2021/10-ServiciosWeb/Ejercicio25/pro/producto', 'Producto', 'idProducto','nombre');
